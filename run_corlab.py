...
"""
Main script for corlab.

Parameter values are specified at the start of the script.
...
u0 = 83.4    # Zonal wind component [m s^-1] DEF = -8.3431
...
curv = True # Curvature [BOOL] DEF = False
fric = False # Friction [BOOL] DEF = False

# Forecast length and number of steps
nD = 5    # Forecast length in days
nt = 1000    # Number of iterations to perform
...
sol = solve_ivp(eqs_of_motion,[0,nS],y,t_eval = tspan,method = 'Radau')
